...
<head>
    ...
    <title>Probe cu Status: Comandat</title>
    ...
    <div class="wrapper" id="test">
        <div class="side left">
            ...
            <div class="caption">
                ...
                <h1>Probe cu status: comandat</h1>
                <table class="lista">
                    <tr>
                        <th>Numar Comanda</th>
                        <th>Nume</th>
                ...
                <?php while($proba = mysqli_fetch_assoc($result)) {?>
                    <tr>
                        ...
                        <td><a class="link_culoare" href="<?php echo url_for('/doctor/probe/prelucrarecomandat.php?id=' . $proba['id']); ?>">Prelucreaza</a> </td>
                    </tr>
                <?php };?>
