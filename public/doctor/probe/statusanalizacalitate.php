...
<head>
    ...
    <title>Probe cu Status ANALIZA CALITATE</title>
            ...
            <div class="caption">
                ...
                <?php while($proba = mysqli_fetch_assoc($result)) {?>
                    <tr>
                        ...
                        <td><a class="link_culoare" href="<?php echo url_for('/doctor/probe/prelucrareanalizacalitate.php?id=' . $proba['id']); ?>">Prelucreaza</a> </td>
                    </tr>
                <?php };?>
