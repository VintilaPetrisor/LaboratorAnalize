...
if(($_SESSION['username'] === $date_logare['utilizator']) || ($_SESSION['pass'] === $date_logare['parola'])){
    ...
    $_SESSION['authuser'] = 1;
    redirect_to(url_for('/doctor/index.php'));
} else {
...
<header class="main-header">
        ...
        <nav class="main-nav">
            <ul class="main-nav__items">
                ...
                <li class="main-nav__item">
                    <a href="<?php echo url_for('/pacient/pacientlogin.php'); ?>" >Logare Pacient</a>
                </li>
            </ul>
        </nav>
    ...
    <div class="wrapper" id="test">
        <div class="side left">
            ...
            <div class="caption">
                ...
                <form class="setform" action="<?php echo url_for('doctor/doctorlogin.php'); ?>" method="post"> 
